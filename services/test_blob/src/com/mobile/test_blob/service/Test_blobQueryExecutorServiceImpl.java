...
@Service
public class Test_blobQueryExecutorServiceImpl implements Test_blobQueryExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(Test_blobQueryExecutorServiceImpl.class);

    @Autowired
    @Qualifier("test_blobWMQueryExecutor")
