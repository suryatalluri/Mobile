...
import com.mobile.test_blob.Table1;
 ...
 * @see Table1
 */
@Service("test_blob.Table1Service")
public class Table1ServiceImpl implements Table1Service {
    ...
    @Transactional(value = "test_blobTransactionManager")
    @Override
	...
	@Transactional(readOnly = true, value = "test_blobTransactionManager")
	@Override
	...
	@Transactional(rollbackFor = EntityNotFoundException.class, value = "test_blobTransactionManager")
	@Override
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service test_blob for table Table1 to {} format", exportType);
