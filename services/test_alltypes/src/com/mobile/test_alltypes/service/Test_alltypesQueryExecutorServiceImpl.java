...
@Service
public class Test_alltypesQueryExecutorServiceImpl implements Test_alltypesQueryExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(Test_alltypesQueryExecutorServiceImpl.class);

    @Autowired
    @Qualifier("test_alltypesWMQueryExecutor")
