...
import com.mobile.test_alltypes.Table1;
 ...
 * @see Table1
 */
@Service("test_alltypes.Table1Service")
public class Table1ServiceImpl implements Table1Service {
    ...
    @Autowired
    @Qualifier("test_alltypes.Table1Dao")
    ...
    @Transactional(value = "test_alltypesTransactionManager")
    @Override
	...
	@Transactional(readOnly = true, value = "test_alltypesTransactionManager")
	@Override
	...
	@Transactional(rollbackFor = EntityNotFoundException.class, value = "test_alltypesTransactionManager")
	@Override
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service test_alltypes for table Table1 to {} format", exportType);
